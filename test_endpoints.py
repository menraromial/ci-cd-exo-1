...
def main():
    ...
    parser.add_argument('--endpoint', choices=['health', 'hello', 'calculator', 'errors', 'performance', 'all'],
                       default='all', help='Endpoint spécifique à tester (défaut: all)')
    parser.add_argument('--performance-requests', type=int, default=10,
                       help='Nombre de requêtes pour le test de performance (défaut: 10)')
